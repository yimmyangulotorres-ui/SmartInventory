...
public class Main {
    ...
    private static void addProduct() {
        ...
        // Show categories and select one
        showCategories();
        ...
        if (category == null) {
            System.out.println("Categoría no encontrada. No se puede agregar el producto.");
            return;
        }
        ...
        System.out.println("Producto asignado a la categoría: " + category.getName());
    ...
    private static void showCategories() {
        ...
        for (Category category : inventory.showCategory()) {
            System.out.println("ID: " + category.getIdCategory() + " | Nombre: " + category.getName());
        }
    }
